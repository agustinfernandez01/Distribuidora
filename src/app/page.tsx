      ...
      <section id="marcas" className="py-20 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-10 flex justify-center">
            <Link href="/productos" className="w-full sm:w-auto px-8 py-3 bg-[#2166b0] text-white text-sm font-medium rounded hover:bg-[#1a5490] transition-all duration-300 transform hover:scale-105">
              Ver todos
            </Link>
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="mb-8">
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">
                  ...
                  <span className="block text-[#2166b0] mt-2 font-normal">con CCU y ADO</span>
                </h2>
                <div className="w-16 h-0.5 bg-gradient-to-r from-[#2166b0] to-[#76c043]"></div>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-[#2166b0]/5 to-[#76c043]/5 p-6 rounded-lg border-l-4 border-[#2166b0]">
                  <p className="text-gray-700 font-medium leading-relaxed">
                    Discomef es distribuidora oficial de CCU y ADO para toda la provincia de Tucumán y Catamarca
                  </p>
                </div>
                ...
                <button
                  onClick={(e) => smoothScroll(e, 'contacto')}
                  className="mt-8 px-8 py-3 bg-[#2166b0] text-white hover:bg-[#1a5490] transition-all duration-300 text-sm font-medium transform hover:scale-105 hover:shadow-lg rounded"
                >
                  Conocer Más
                </button>
              </div>
